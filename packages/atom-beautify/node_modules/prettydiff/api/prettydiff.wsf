    ...
    <job id="main">
        <script type="text/javascript" src="../prettydiff-min.js">
            ...
            (function () {
                ...
                var args = {},
                    ...
                    outerror = function (x) {
                        ...
                        if (WScript.Arguments.Count() === 0 || help === true) {
                            ...
                            error.push("-------------------------------------");
                            error.push("* alphasort    - boolean - If true items will be sorted by type and then alphabetically in their respective scope. Defaults to false. Perfectly safe in CSS but considered harmful in LESS and SASS.");
                            error.push("");
                            ...
                            error.push("");
                            error.push("* objsort      - boolean - If true properties of object literals will be sorted alphabetically in JavaScript and JSON.");
                            error.push("");
                            ...
                            error.push("");
                            error.push("* vertical     - boolean - If you ever wanted to see your object properties, variable lists, or assignment lists vertically aligned for faster and easier reading this option is for you. It accepts boolean values and defaults to");
                            error.push("");
                            error.push("* wrap         - string  - The number of characters text content in a markup document is allowed before wrapping onto a new line.  Default is 0 which disables text wrapping.");
                            error.push("");
                    ...
                    opendir = function (x, y) {
                        ...
                        if (a.FolderExists(x) === true) {
                            ...
                            e = d.Files;
                            f = new Enumerator(e);
                            for (f; f.atEnd() === false; f.moveNext()) {
                                h = f.item().name;
                                if (ext[0] === "") {
                                    g.push(h + "\n");
                                } else {
                ...
                if (fail === false) {
                    args.api = "wsf";
                    args.alphasort = (WScript.Arguments.Named("alphasort") === "true" || WScript.Arguments.Named("alphasort") === true) ? true : false;
                    args.comments = (WScript.Arguments.Named("comments") === "noindent") ? "noindent" : "indent";
                    args.conditional = (WScript.Arguments.Named("conditional") === "true" || WScript.Arguments.Named("conditional") === true) ? true : false;
                    args.content = (WScript.Arguments.Named("content") === "true" || WScript.Arguments.Named("content") === true) ? true : false;
                    args.context = (isNaN(WScript.Arguments.Named("context"))) ? "" : Number(WScript.Arguments.Named("context"));
                    args.correct = (WScript.Arguments.Named("correct") === "true" || WScript.Arguments.Named("correct") === true) ? true : false;
                    args.csvchar = WScript.Arguments.Named("csvchar") || ",";
                    args.diffcomments = (WScript.Arguments.Named("diffcomments") === "true" || WScript.Arguments.Named("diffcomments") === true) ? true : false;
                    ...
                    args.elseline = (WScript.Arguments.Name("elseline") === "true" || WScript.Arguments.Name("elseline") === true) ? true : false;
                    args.force_indent = (WScript.Arguments.Named("force_indent") === "true" || WScript.Arguments.Named("force_indent") === true) ? true : false;
                    args.html = (WScript.Arguments.Named("html") === "true" || WScript.Arguments.Named("html") === true) ? true : false;
                    ...
                    args.objsort = (WScript.Arguments.Named("objsort") === "true" || WScript.Arguments.Named("objsort") === true) ? true : false;
                    ...
                    args.topcoms = (WScript.Arguments.Named("topcoms") === "false" || WScript.Arguments.Named("topcoms") === false) ? false : true;
                    args.vertical = (WScript.Arguments.Named("vertical") === "true" || WScript.Arguments.Named("vertical") === true) ? true : false;
                    args.wrap = (isNaN(WScript.Arguments.Named("force_indent"))) ? 0 : WScript.Arguments.Named("force_indent");
                ...
                if (fail === false) {
                    ...
                    if (pd[0].indexOf("Error: ") === 0) {
                        ...
                        report.push(pd[1]);
                        report.push("</div>");
                        if (args.jsscope === true && args.mode === "beautify" && (args.lang === "javascript" || args.lang === "auto")) {
                            report.push(pd[0]);
                    ...
                    if (typeof output === "string" && output !== "") {
                        ...
                        if (args.mode === "diff" || (args.jsscope === true && args.mode === "beautify" && (args.lang === "javascript" || args.lang === "auto"))) {
                        ...
                        if (WScript.Fullname.indexOf("cscript.exe") > -1) {
                            if (args.mode === "diff" || (args.jsscope === true && args.mode === "beautify")) {
